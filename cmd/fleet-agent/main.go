// Command fleet-agent is the fleet host's microVM API. It is mTLS-only; the control plane
...
import (
	...
	"github.com/chelodo/fleet/internal/fleetagent"
)
...
func main() {
	...
	go func() {
		log.Info("fleet-agent listening", "addr", *listen, "max_vms", cfg.MaxVMs)
